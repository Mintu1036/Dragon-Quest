...
public class PlayerRespawn : MonoBehaviour
{
    ...
    private Transform currentCheckpoint; //We'll stroe our last checkpoint here
    ...
    public void CheckRespawn()
    {
        ...
        if(currentCheckpoint == null)
        {
            ...
            return; //Don't executer the rest of this function
        }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.transform.tag == "Checkpoint")
        {
            ...
            collision.GetComponent<Collider2D>().enabled = false; //Deacctivate checkpoint collider
